...
def insert_data():
    ...
    if itemId == "" or itemId == " ":
        print("Error Indserting ID")
    elif itemName == "" or itemName == " ":
        print("Error Indserting Name")
    elif itemPrice == "" or itemPrice == " ":
        print("Error Indserting Price")
    elif itemQuantity == "" or itemQuantity == " ":
        print("Error Indserting Quantity")
    else:
...
buttonEnter = Button(
    root,text='Enter',padx=5,pady=5,width=5,bd=3,font=('Arial',15),bg="#0099ff",command=insert_data
)
buttonEnter.grid(row=5,column=1,columnspan=1)


buttonUpdate = Button(
    root,text='Update',padx=5,pady=5,width=5,bd=3,font=('Arial',15),bg="#ffff00",command=update_data
)
buttonUpdate.grid(row=5,column=2,columnspan=1)

buttonDelete = Button(
    root,text='Delete',padx=5,pady=5,width=5,bd=3,font=('Arial',15),bg="#e62e00",command=delete_data
)
